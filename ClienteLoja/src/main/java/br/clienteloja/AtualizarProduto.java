...
public class AtualizarProduto {
    ...
    public static String callSoapWebService(String soapEndpointUrl, String soapAction, int id, String nome, int quantidade, double preco) {
        try {
            // Criar conexão SOAP
            ...
            SOAPMessage soapRequest = createSOAPRequest(id, nome, quantidade, preco);
    ...
    private static SOAPMessage createSOAPRequest(int id, String nome, int quantidade, double preco) throws Exception {
        // Criar mensagem SOAP
        MessageFactory messageFactory = MessageFactory.newInstance();
        SOAPMessage soapMessage = messageFactory.createMessage();

        // Criar envelope SOAP
        createSoapEnvelope(soapMessage, id, nome, quantidade, preco);
        soapMessage.saveChanges();

        return soapMessage;
    }

    private static void createSoapEnvelope(SOAPMessage soapMessage, int id, String nome, int quantidade, double preco) throws SOAPException {
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("atualizarProduto", myNamespace);
